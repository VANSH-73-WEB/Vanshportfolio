...
const Skill = () => {
  ...
  return (
    <section id="Skill" className="Skill"  style={{
      ...
      <div className="skill-inner" ref={innerRef}>
...
<div className="box1" data-aos="fade-right" data-aos-delay="700">
      <div className="nodejs" >
       <img src="https://img.icons8.com/?size=100&id=shQTXiDQiQVR&format=png&color=000000" alt="MongoDB" />
      </div>
      </div>
...
<div className="certificates" data-aos="fade-right" data-aos-delay="100">
  ...
  <ul className="cert-list">
    <li data-aos="fade-left" data-aos-delay="200">
      ...
      <a href="https://coursera.org/verify/OURNZKDCH9U0" target="_blank" rel="noreferrer">View Certificate</a></span>
    </li>
    <li data-aos="fade-left" data-aos-delay="300">
      <strong>JavaScript</strong>   <span>GUVI:-
      <a href="https://www.guvi.in/share-certificate/197283854bX502dDHG" target="_blank" rel="noreferrer">View Certificate</a></span>
    </li>
    <li data-aos="fade-left" data-aos-delay="400">
      <strong>Course on DevOps</strong><span> Tech Vision Techonologies:-
      <a href="https://res.cloudinary.com/dumxf8ky8/image/upload/v1757857484/DevOps_eyhzwl.jpg" target="_blank" rel="noreferrer">View Certificate</a>
    </span>
    </li>
    <li data-aos="fade-left" data-aos-delay="500">
      <strong>Getting Started with Artificial Intelligence</strong> <span> IBM SkillsBuild:-
      <a href="https://www.credly.com/badges/d854bfa6-00fc-402b-a4f9-51590a7470dd/public_url" target="_blank" rel="noreferrer">View Certificate</a>
    </span>
    </li>
  </ul>
</div>
